...
## [2.62.0](https://github.com/BRAVO68WEB/emailengine-foss/compare/v2.61.5...v2.62.0) (2026-01-29)


### Features

* add AES-256-GCM encryption at rest for export files ([4f67269](https://github.com/BRAVO68WEB/emailengine-foss/commit/4f6726915bd40087c0f447a7f2cb36943e8a849a))
* Add bounce message classification using ML model ([e337ceb](https://github.com/BRAVO68WEB/emailengine-foss/commit/e337cebfb813192c385687c510c9e189d3eb0854))
* Add check-bounce CLI command for analyzing bounce emails ([ae3a85d](https://github.com/BRAVO68WEB/emailengine-foss/commit/ae3a85dd5acdf9c893196284487e536ac3d6d9ec))
* add configurable batch sizes for Gmail/Outlook exports ([a4d178c](https://github.com/BRAVO68WEB/emailengine-foss/commit/a4d178ceee195825d7f05a263897a873c361b296))
* Add dedicated page to view accounts assigned to IMAP worker threads ([6d7e69e](https://github.com/BRAVO68WEB/emailengine-foss/commit/6d7e69e35230a3a11076d65174ef1ed7e0ecc144))
* Add Exim-style bounce detection for diagnostic messages ([b82e588](https://github.com/BRAVO68WEB/emailengine-foss/commit/b82e588d3e699f3c757c6a01f3fb9933c94bbb4c))
* add export beta notice and status indicator in UI ([271bd18](https://github.com/BRAVO68WEB/emailengine-foss/commit/271bd1899241903c50f582827e0f08306c79cb1d))
* add export reliability improvements and resume capability ([9f78644](https://github.com/BRAVO68WEB/emailengine-foss/commit/9f78644cc1801bf64725bbde47c0910aab69769b))
* add export UI to admin account page ([cf3ce49](https://github.com/BRAVO68WEB/emailengine-foss/commit/cf3ce4979b6a4547081c2bea534a7327ebe73009))
* add global concurrent export limit and performance optimizations ([20a1272](https://github.com/BRAVO68WEB/emailengine-foss/commit/20a1272ca20ee9961c5163a0c5d8c5452cb6b556))
* add include attachments option to export UI ([2b8d2c6](https://github.com/BRAVO68WEB/emailengine-foss/commit/2b8d2c6cd60eb72556a1f1a4db03abf0cdc14e6f))
* Add MS Graph webhook subscription state metrics ([3e3ad18](https://github.com/BRAVO68WEB/emailengine-foss/commit/3e3ad184d013770d6defbe71f21072969fe105be))
* Add OAuth2 API metrics for MS Graph and Gmail backends ([9a8182c](https://github.com/BRAVO68WEB/emailengine-foss/commit/9a8182cf82c1493e472573b97dded8660feaff7f))
* Add OAuth2 token refresh metrics to all refresh paths ([4c23c90](https://github.com/BRAVO68WEB/emailengine-foss/commit/4c23c903edf916367ffc3bcd1b1abe97cf783bc6))
* add parallel message fetching for Gmail/Outlook export ([12de963](https://github.com/BRAVO68WEB/emailengine-foss/commit/12de963abe8f6922a8840e8291e57a5dcf03e584))
* Add Prometheus metrics and Grafana dashboard ([e3d4088](https://github.com/BRAVO68WEB/emailengine-foss/commit/e3d4088751ab0d04ea86425bbcea02ca49afbc90))
* Add support for Gmail send-only accounts ([#554](https://github.com/BRAVO68WEB/emailengine-foss/issues/554)) ([47fb593](https://github.com/BRAVO68WEB/emailengine-foss/commit/47fb593cfe390f066bd99ff84257abb036782d64))
* Add support for Outlook send-only accounts ([6b63ee4](https://github.com/BRAVO68WEB/emailengine-foss/commit/6b63ee4dff1feff087ab65e6233317cae8a4aad7))
* **api:** Add mailbox subscription management to modify endpoint ([4578c8a](https://github.com/BRAVO68WEB/emailengine-foss/commit/4578c8a89f56725ec02a3d9e2418c141acea4db1))
* Attachments in new message webhooks ([#514](https://github.com/BRAVO68WEB/emailengine-foss/issues/514)) ([81d0d8f](https://github.com/BRAVO68WEB/emailengine-foss/commit/81d0d8f48a7bcc5a9ac1a9c5b00e7556fad2edb0))
* display export expiration date in UI ([5e1e633](https://github.com/BRAVO68WEB/emailengine-foss/commit/5e1e6334e13b3b1ff012bfd76b933548c6cb6d83))
* **health:** Add worker health monitoring with heartbeat system ([34724e8](https://github.com/BRAVO68WEB/emailengine-foss/commit/34724e876a021d6de30bffff54856bb9a2c6ef76))
* Improve ARF complaint detection and add comprehensive tests ([5533552](https://github.com/BRAVO68WEB/emailengine-foss/commit/55335526a19c6948675d126d1dbb14db353253a0))
* Improve autoreply detection and add comprehensive tests ([1cf179f](https://github.com/BRAVO68WEB/emailengine-foss/commit/1cf179f8289eb05e8add420fe02d6410f61718cc))
* Improve bounce detection coverage for non-standard formats ([5393872](https://github.com/BRAVO68WEB/emailengine-foss/commit/53938724c699b32177ece83c3d88be9a5432c067))
* Improve bounce detection for legacy formats ([90a0289](https://github.com/BRAVO68WEB/emailengine-foss/commit/90a0289f7999e23149e14ff6ea5d703de056d5b0))
* **internals:** Add CPU monitoring for worker threads ([8aa9be5](https://github.com/BRAVO68WEB/emailengine-foss/commit/8aa9be5ab7a09c7d12745d2ddc3632da868d0bcb))
* **oauth2-apps:** Added search field to the OAuth2 application listing page to search OAuth2 applications ([69144fe](https://github.com/BRAVO68WEB/emailengine-foss/commit/69144fe01fdfba3d5448419a7ef46abba5c1aa4c))
* **outlook:** Add MS Graph API category support via labels API ([7de3586](https://github.com/BRAVO68WEB/emailengine-foss/commit/7de35863d4922ebd4fde4a2e448649a29bfc00b3))
* **outlook:** Add optional structured format for MS Graph sendMail ([5062e84](https://github.com/BRAVO68WEB/emailengine-foss/commit/5062e845fe29f16cdb7cce23b767657e1b283dfb))
* Replace static help.txt with dynamic CLI help system ([4cd5fb0](https://github.com/BRAVO68WEB/emailengine-foss/commit/4cd5fb059c2bf7436c4262a7daee1e85f535c322))
* **resilience:** Add circuit breaker pattern for worker communication ([79ea27a](https://github.com/BRAVO68WEB/emailengine-foss/commit/79ea27aed0ae7c5c856746809d43f53bacf3ed2b))
* **sending:** Support 'Idempotency-Key' header for /submit message requests and 'X-EE-Idempotency-Key' SMTP header to avoid sending duplicate emails ([1423135](https://github.com/BRAVO68WEB/emailengine-foss/commit/1423135b7049449bfb4be68cc03baa7f1b6a1a62))
* **ui:** Added message browser to account view ([a1e27d8](https://github.com/BRAVO68WEB/emailengine-foss/commit/a1e27d8004631d62849ba7f08451eec0cc731cca))
* Use persistent SMTP connections instead of logging separately for every email sent by the same account ([866e24f](https://github.com/BRAVO68WEB/emailengine-foss/commit/866e24fd06760ab92752629b259577fcf620b781))


### Bug Fixes

* accept base64-encoded nonces for backward compatibility ([2c46822](https://github.com/BRAVO68WEB/emailengine-foss/commit/2c46822a46ce1b2dc632f9a20f5831eabad3b623))
* add BullMQ stalled job configuration to prevent queue hangs ([23a74c3](https://github.com/BRAVO68WEB/emailengine-foss/commit/23a74c359e131baafd12dcf08d213eac0d96840f))
* Add EENGINE_DISABLE_SETUP_WARNINGS environment variable ([933a4f7](https://github.com/BRAVO68WEB/emailengine-foss/commit/933a4f7c8935f1aeadab5b65c6454460e6e191d5))
* Add EENGINE_ENABLE_OAUTH_TOKENS_API environment variable support ([be74bf9](https://github.com/BRAVO68WEB/emailengine-foss/commit/be74bf9b92ea20b9f0cbb7cf336036e4c2e5cf7b))
* Add environment variable support and deprecate unused OAuth2 fields ([a63fa8b](https://github.com/BRAVO68WEB/emailengine-foss/commit/a63fa8b93073b325422d7ed4ea034e4d53ad2b2b))
* add error logging for MS Graph subscription creation failures ([ba928e4](https://github.com/BRAVO68WEB/emailengine-foss/commit/ba928e495acb7fcc8c18e6cf34c917a2f4ad3337))
* add forced exit to prevent test timeout in CI ([aeb7261](https://github.com/BRAVO68WEB/emailengine-foss/commit/aeb726169b26e7263acb55041112f5a97a818b8a))
* add labels to remaining Joi schemas for stable OpenAPI names ([4e7e064](https://github.com/BRAVO68WEB/emailengine-foss/commit/4e7e064063f9e882ec94ada9d0dd1aad6567c675))
* Add retry logic for transient errors when fetching referenced messages ([9312f4b](https://github.com/BRAVO68WEB/emailengine-foss/commit/9312f4bcc95b2423e4bd98e3eeef1230aa02fcb9))
* **AI:** Add GPT-5 support with updated token limits ([f99947a](https://github.com/BRAVO68WEB/emailengine-foss/commit/f99947a34ff25ad0224c1b8e828d7cf104fd26a5))
* Allow adding shared MS accounts directly via the /v1/accounts endpoint ([c77e61e](https://github.com/BRAVO68WEB/emailengine-foss/commit/c77e61ea16d67c84b1a7b1b0d49f60f577a73839))
* **api:** Added new method to list Gmail signatures for an account ([c7e379a](https://github.com/BRAVO68WEB/emailengine-foss/commit/c7e379aad46843419dad0ce2fd30f269a241c484))
* **api:** Improved message-move API endpoint for Gmail API accounts. There is now a new payload option 'source' that specifies the folder the message is moved from ([861bc23](https://github.com/BRAVO68WEB/emailengine-foss/commit/861bc2369229346815863859dfe2d5281748e865))
* **attachments:** Bumped Nodemailer for fix issue with large data-uri images in emails ([64a498c](https://github.com/BRAVO68WEB/emailengine-foss/commit/64a498cccc8123958761c99e33164849378f2d07))
* **attachments:** Bumped Nodemailer for fix issue with large data-uri images in emails ([44cd002](https://github.com/BRAVO68WEB/emailengine-foss/commit/44cd002933635435626739e395bfdf8ba9679be2))
* Bumped dependencies to get rid of security warnings ([54b13c4](https://github.com/BRAVO68WEB/emailengine-foss/commit/54b13c4c4a42c7af886c63a97b6cdbb4dc8696b1))
* Bumped deps to fix formwat=flowed parsing issue ([efffe4e](https://github.com/BRAVO68WEB/emailengine-foss/commit/efffe4e7be778667a1119343e71e86817e1dc71e))
* Bumped email-text-tools to fix webSafe processing ([ae6f2f1](https://github.com/BRAVO68WEB/emailengine-foss/commit/ae6f2f149ab675faaa9de5490809400b5c24996d))
* Bumped ImapFlow module for improved IMAP handling stability ([5f7ce73](https://github.com/BRAVO68WEB/emailengine-foss/commit/5f7ce73eb270f3f92fdd17398842ad003c628612))
* Bumped ImapFlow to decrease load on CPU ([227894d](https://github.com/BRAVO68WEB/emailengine-foss/commit/227894dbbc68f6b7d5cf5322d1010678940107c1))
* **connection-counter:** Only decrease connection counter if a connection was actually removed ([d402888](https://github.com/BRAVO68WEB/emailengine-foss/commit/d4028884ad4261eaf0c09faedab8bb395a92abde))
* Correct API schema documentation and descriptions ([8a51465](https://github.com/BRAVO68WEB/emailengine-foss/commit/8a514650c8422b666244164aa71fe1d7b6f0ec2b))
* Correct CPU usage chart unit from seconds to dimensionless ([88765bc](https://github.com/BRAVO68WEB/emailengine-foss/commit/88765bc137a6dedafdaee8c6677b5e4e8ef2eec6))
* Correct OpenAPI response schema and add Docker CLI support ([38d39d6](https://github.com/BRAVO68WEB/emailengine-foss/commit/38d39d615d7e268261f4d8b49a7e79a943d9c553))
* Correct y-positions of Redis panels in Grafana dashboard ([12fdeff](https://github.com/BRAVO68WEB/emailengine-foss/commit/12fdeff1c4f837e7c37ebdb6c5647b01fb49c467))
* dark mode support for message browser ([59d3c31](https://github.com/BRAVO68WEB/emailengine-foss/commit/59d3c31d58ea46d31b9908188b599c2169da87f7))
* **delegated-oauth:** Handle delegated MS Graph account properly if created using delegated=true ([4cece01](https://github.com/BRAVO68WEB/emailengine-foss/commit/4cece016eac3033aae14422a31444c93c8375423))
* **delegated:** Fixed mailbox listing for delegated OAuth2 accounts ([9fc74fd](https://github.com/BRAVO68WEB/emailengine-foss/commit/9fc74fd41e00a92eb121a85efa134947497de608))
* **deps:** Bumped ImapFlow to handle invalid BODYSTRUCTURE from BlueMind ([1174a29](https://github.com/BRAVO68WEB/emailengine-foss/commit/1174a29aea60f5f2fc24c35eb565f0e2e1633e86))
* **deps:** Bumped ImapFlow to improve handling of unstable IMAP connections ([3dfa5fa](https://github.com/BRAVO68WEB/emailengine-foss/commit/3dfa5fa7f0dfcb99f3319dd4bbbb1d4cdb14c5b6))
* Detect "Out of the Office" autoreply subject pattern ([7191c50](https://github.com/BRAVO68WEB/emailengine-foss/commit/7191c50ae62930a66bf6598cb55f94130e022cf9))
* **dockerfile:** Unpin Node version ([4feb420](https://github.com/BRAVO68WEB/emailengine-foss/commit/4feb420009a7af613343690007d787063e20e1a0))
* **docker:** Pin Node version in Dockerfile ([decb751](https://github.com/BRAVO68WEB/emailengine-foss/commit/decb7510ef9e9b107277c8d687ab8e3af94b3975))
* **docker:** Publish tags to Github Registry as well ([24db762](https://github.com/BRAVO68WEB/emailengine-foss/commit/24db762b72a3bf45679e4c0263c35a24f9bb261f))
* **docker:** reverted docker release action ([c205aae](https://github.com/BRAVO68WEB/emailengine-foss/commit/c205aae5953a63e2fab1cf52e534468d3dedddeb))
* downgrade transient connection/timeout error logs to warn level ([9064529](https://github.com/BRAVO68WEB/emailengine-foss/commit/9064529a0d21cd6198386c73d9abca3447f6dc31))
* Dutch translations ([#526](https://github.com/BRAVO68WEB/emailengine-foss/issues/526)) ([ebbd783](https://github.com/BRAVO68WEB/emailengine-foss/commit/ebbd783d5787f056b1d25a22f15932b18dd6deff))
* Enable NPM package publishing ([051f4d6](https://github.com/BRAVO68WEB/emailengine-foss/commit/051f4d638ccea94f22d08924e300fa8672b51d9d))
* **encryption:** Cache keys in memory to avoid using scrypt every time a secret is accessed ([cbfcde5](https://github.com/BRAVO68WEB/emailengine-foss/commit/cbfcde507cbb920ac888e0c23f13437c0b4017f4))
* Ensure mailbox ID persistence during flush ([bb26992](https://github.com/BRAVO68WEB/emailengine-foss/commit/bb26992f110e640fa0f98f64dd714a20ac35c085))
* **env:** Added EENGINE_DISABLE_MESSAGE_BROWSER, fixed EENGINE_ADMIN_ACCESS_ADDRESSES regression bug ([4d922ff](https://github.com/BRAVO68WEB/emailengine-foss/commit/4d922ff9c7eb7ca6839657430adc3df7013a7204))
* Exclude browser-only deps from pkg bundle ([994dd41](https://github.com/BRAVO68WEB/emailengine-foss/commit/994dd4169c5324d411feed804f277de119854916))
* **filename:** Fixed filename handling for message responses from servers without parameter continuation support ([1463506](https://github.com/BRAVO68WEB/emailengine-foss/commit/14635065b2d5a9c12190aa3f5b2a5177948f0d01))
* Fix OAuth2 token refresh metrics not being recorded ([a6bf696](https://github.com/BRAVO68WEB/emailengine-foss/commit/a6bf6964e5b412bde5b44630eb20a3af59d2e700))
* Fixed build ([ac5d3b4](https://github.com/BRAVO68WEB/emailengine-foss/commit/ac5d3b4b700752e42acd0b7028bfdf622eac1f0a))
* Fixed checking nil against a number ([eee7294](https://github.com/BRAVO68WEB/emailengine-foss/commit/eee7294d1e4cd328ba1cff8aeb704d86a6fd767f))
* **flush:** Allow flushing non-connected accounts ([07eebc5](https://github.com/BRAVO68WEB/emailengine-foss/commit/07eebc55ba2d4341d92fb7a1d9078449750b2a7c))
* force Swagger UI to light mode only ([4c26d12](https://github.com/BRAVO68WEB/emailengine-foss/commit/4c26d12437feaacd26da88a6fb3e85a7ca2ee238))
* **gmail-api:** clear label cache after modifying labels ([ca60f89](https://github.com/BRAVO68WEB/emailengine-foss/commit/ca60f89e8eddc736da5fd4fab33029fc4947c3fc))
* **gmail-api:** Fixed special use label handling when updating messages ([9e06ed7](https://github.com/BRAVO68WEB/emailengine-foss/commit/9e06ed79c3c1e4db0995df64f84c587e02645a7e))
* **gmail-api:** Show a failure message if OAuth2 configured scopes are insufficient ([f72b5f3](https://github.com/BRAVO68WEB/emailengine-foss/commit/f72b5f3f72d03f1750d36f5adffa525d1b90c1d9))
* **gmail-watch:** Allow setting subscription name for Gmail PubSub ([529f698](https://github.com/BRAVO68WEB/emailengine-foss/commit/529f698837a90f4f813832026fcafcc1e62762e9))
* **gmail-watch:** Log and show information watch renewal failures ([7a59ce9](https://github.com/BRAVO68WEB/emailengine-foss/commit/7a59ce9a97a2e9d5c44e20598a1f3d2c7a1f3ae8))
* **gmail:** Exclude OpenID scopes from service account authentication ([faf7821](https://github.com/BRAVO68WEB/emailengine-foss/commit/faf7821ddac184ba481c9acc9f0a38d2baaf834c))
* **google-oauth:** Allow to specify the PubSub Topic Name instead of using the autogenerated value ([41f362b](https://github.com/BRAVO68WEB/emailengine-foss/commit/41f362b96aa250591e190a565a24683b313fc93e))
* handle delegation errors in loadAccountData, isApiClient, and UI listing ([c306618](https://github.com/BRAVO68WEB/emailengine-foss/commit/c306618a37428bbf088ed1289bf832e778f14b9c))
* handle empty or invalid JSON responses from OAuth APIs ([57d8886](https://github.com/BRAVO68WEB/emailengine-foss/commit/57d8886a0d29b20df4b575bac8210f6ed97f7fa3))
* handle non-iterable messageInfo.attachments in mailbox sync ([3187571](https://github.com/BRAVO68WEB/emailengine-foss/commit/31875714e0ceb8e8711c910f6c561e1b1fe81a50))
* handle notificationBaseUrl without trailing slash in prepareUrl ([1048818](https://github.com/BRAVO68WEB/emailengine-foss/commit/1048818fe1b1a193a8d5f1b99a37285b54bd9317))
* handle uncaught EPIPE in ResponseStream for SSE endpoints ([ca7af4a](https://github.com/BRAVO68WEB/emailengine-foss/commit/ca7af4ad7a4fa6ccc02dcaee79f06d33bd38e8b8))
* Harden bounce detection against edge cases and ReDoS attacks ([d6c72c2](https://github.com/BRAVO68WEB/emailengine-foss/commit/d6c72c29d4c2bc1a20025204cc0cf20f803b04a6))
* harden OAuth token request body serialization and error handling ([296c4e9](https://github.com/BRAVO68WEB/emailengine-foss/commit/296c4e99fd00928fa0682f2c735c2d81c1a74bcf))
* **http-requests:** Use undici RetryAgent for HTTP request network errors and 429 rate limiting, removed custom 429 handler ([bafcd1c](https://github.com/BRAVO68WEB/emailengine-foss/commit/bafcd1c1551a2c00809b07d31e2ba67b1c9d19df))
* **imap-auth:** Bumped ImapFlow dependency to fix issue with AUTHENTICATE LOGIN on some IMAP servers ([c1a5fba](https://github.com/BRAVO68WEB/emailengine-foss/commit/c1a5fbaedd7c1d3ade881ee48db8cc9e238a042b))
* **imap-proxy:** Fixed regression bug in IMAP proxy interface ([612d9f9](https://github.com/BRAVO68WEB/emailengine-foss/commit/612d9f963402a952bfaee41eeda09acd6e6225aa))
* **imap:** Fix uneven IMAP worker thread distribution ([339f0e0](https://github.com/BRAVO68WEB/emailengine-foss/commit/339f0e0b8f7a382a42c29460526a9ddfac91a0fe))
* **imap:** Fixed subconnection error handling ([5367c77](https://github.com/BRAVO68WEB/emailengine-foss/commit/5367c77f88690a3636049e0690d2f674e1528a30))
* **imap:** Prevent 100% CPU usage from reconnection loops ([4d1bf7d](https://github.com/BRAVO68WEB/emailengine-foss/commit/4d1bf7da53d299f0b203eb09b4ec790848c6cf09))
* Improve auth-server example with proper error handling and documentation ([cef5b47](https://github.com/BRAVO68WEB/emailengine-foss/commit/cef5b47378bdb18a1ff136fd29e8c63dd566cb86))
* improve BullMQ efficiency with jitter, retention, and cleanup ([fb48fd8](https://github.com/BRAVO68WEB/emailengine-foss/commit/fb48fd84065fe44a4bf5054ced45f4bffc9c8153))
* Improve OAuth token refresh error handling and state management ([5be242b](https://github.com/BRAVO68WEB/emailengine-foss/commit/5be242bd5392ff08f83d7709ad4f82f8f218e05d))
* improve packUid robustness with fallback and validation ([4b4253e](https://github.com/BRAVO68WEB/emailengine-foss/commit/4b4253e3fd025070b42c3d012071dd6376191692))
* improve submit resilience during worker restarts and add batch endpoint ([f559c38](https://github.com/BRAVO68WEB/emailengine-foss/commit/f559c3818bb727b137f5a2b8b32b0efee48a093d))
* Increase openAiPrompt max size from 6KB to 1MB ([29d673d](https://github.com/BRAVO68WEB/emailengine-foss/commit/29d673d6bf35f78c3ef53ec1b690c49deecd889c))
* **inline-html:** Fixed reply and forward inline emails if only text was set ([2efaa77](https://github.com/BRAVO68WEB/emailengine-foss/commit/2efaa77c122b099a2607e045c10cb6ab05900e78))
* **install:** Fixed Redis password generation for the install script ([bf5853e](https://github.com/BRAVO68WEB/emailengine-foss/commit/bf5853e0c394a98d3bad079293dd5e73206d5183))
* **internals:** Handle unresponsive workers gracefully in admin internals page ([2a2d94b](https://github.com/BRAVO68WEB/emailengine-foss/commit/2a2d94b916e32b7a5f8a2741dbd8fbb265b98605))
* **language:** Added language selection with ?locale=et query argument ([b911ec3](https://github.com/BRAVO68WEB/emailengine-foss/commit/b911ec31e93c75be281d7f79f18b9dcbab2ba1cb))
* limit session token usage for the message browser ([41ead92](https://github.com/BRAVO68WEB/emailengine-foss/commit/41ead924917930f828f996b43c6a16a73c8c7bb9))
* **lint:** Remove unused HEARTBEAT_INTERVAL constant and add npm lint script ([19209ab](https://github.com/BRAVO68WEB/emailengine-foss/commit/19209ab254bfa1262fa5e34f994db51ebca61f5a))
* **LLM integration:** Add configurable max tokens setting for OpenAI API ([a746388](https://github.com/BRAVO68WEB/emailengine-foss/commit/a746388c0b69746f21f6ac95e49d7797bb8f9722))
* **lua:** Fix bugs and add documentation to Redis Lua scripts ([1c4889f](https://github.com/BRAVO68WEB/emailengine-foss/commit/1c4889f9e055e3c9b16b11513583abc494c92a15))
* maintenance release ([bed7e16](https://github.com/BRAVO68WEB/emailengine-foss/commit/bed7e16ff3377fcca6e5a47fc69a987aed511514))
* **markAsSeen:** fix markAsSeen option for Gmail API and MS Graph API ([7e2dcdc](https://github.com/BRAVO68WEB/emailengine-foss/commit/7e2dcdcbd4a9726855f5ec216fac0d4212ca2e5f))
* Memory leak fixes for IMAP client and webhooks worker ([b749f96](https://github.com/BRAVO68WEB/emailengine-foss/commit/b749f964f7e8de6828d23b8c3c5a3ca11e15898a))
* **memory:** Add LRU-based cleanup for SMTP connection pools ([fba58e8](https://github.com/BRAVO68WEB/emailengine-foss/commit/fba58e8069d74a0738cebab478188eee31749678))
* message browser uses theme based confirm instead of sync javascript confirm ([9409d2c](https://github.com/BRAVO68WEB/emailengine-foss/commit/9409d2c7e4a93fd9ab16876baf52294968511840))
* **message-upload:** Fix message upload if uploading to a child folder of Inbox using MS Graph API ([2c14b5e](https://github.com/BRAVO68WEB/emailengine-foss/commit/2c14b5eb80ff1fe60e03504bd6550e06698210ee))
* **message/rfc822:** Fixed message/rfc822 attachment handling when sending emails ([af2bf30](https://github.com/BRAVO68WEB/emailengine-foss/commit/af2bf308a7634c01c065f06c75503597b6c42690))
* **messageBounce:** Check messages in the Junk folder as well for bounces ([0def3e3](https://github.com/BRAVO68WEB/emailengine-foss/commit/0def3e3635376118ea9379369f018b52f0f8d66e))
* **metrics:** Implement background metrics collection to prevent CPU spikes ([b0a200a](https://github.com/BRAVO68WEB/emailengine-foss/commit/b0a200a8e491bddcf1a3896e12253523036ad339))
* move from OAS v2 to OAS v3 ([49e7018](https://github.com/BRAVO68WEB/emailengine-foss/commit/49e7018d8003397bce7383c7aac6b39c1ff1e3d0))
* **ms-graph-api:** Fix fetching message/rfc822 attachments ([c55bcbd](https://github.com/BRAVO68WEB/emailengine-foss/commit/c55bcbdcd1dc88c2ed3b4442fb8c074e31c9256c))
* **ms-graph-api:** Fixed plaintext content handling when retrieving emails from MS Graph API ([0166a0a](https://github.com/BRAVO68WEB/emailengine-foss/commit/0166a0a8121feab6900da49d2d544899f2f23fd7))
* **ms-graph-api:** Upload message as a JSON structure instead of EML with MS Graph API in order to set meta info like flags ([c7fde6f](https://github.com/BRAVO68WEB/emailengine-foss/commit/c7fde6fedb127773cfbf4cff1937cad1a91148cd))
* **ms-graph:** Added new setting notificationBaseUrl to set a different webhook URLs for MS Graph notificationUrl and lifecycleNotificationUrl than serviceUrl ([0963041](https://github.com/BRAVO68WEB/emailengine-foss/commit/09630414cd80b37cb9c223b3acd140dffac64d12))
* **MS-Graph:** Fixed IMAP and SMTP hosts for Government Cloud accounts ([e78a9cb](https://github.com/BRAVO68WEB/emailengine-foss/commit/e78a9cb6c480c740c2c3abb9b50a8c7c7f6e7ee7))
* **multi-operations:** Added new search term 'emailIds', if set it will use the predefined email IDs instead of executing the search ([aac3aab](https://github.com/BRAVO68WEB/emailengine-foss/commit/aac3aab65e1eea3b51ea302b5634f3e2b1a30063))
* **no active handler:** Return 503 error, not 200 ([d1e0702](https://github.com/BRAVO68WEB/emailengine-foss/commit/d1e070292df2000005cca2f000094fc21e5d43df))
* **no-active-handler:** Fixed response code 200 for No Active Handler response ([067a37b](https://github.com/BRAVO68WEB/emailengine-foss/commit/067a37b4326d4ab0f4d2ae188220a0716921c0f0))
* normalize OAuth2 subscription keys ([a400e73](https://github.com/BRAVO68WEB/emailengine-foss/commit/a400e7397d509ef6bba1a47d7dd8535b019862c4))
* **notificationBaseUrl:** Allow using a path component in the base URL ([d2af058](https://github.com/BRAVO68WEB/emailengine-foss/commit/d2af058cc987636481093466e4ffe7574782533b))
* **oauth-smtp:** Fixed authentication username for shared outlook SMTP accounts ([c4ca913](https://github.com/BRAVO68WEB/emailengine-foss/commit/c4ca913f14321cc8c852158c8d9cdecf0eb58061))
* **oauth2:** Fixed issues with OAuth2 periodic renewals (subscriptions etc) ([046bd55](https://github.com/BRAVO68WEB/emailengine-foss/commit/046bd5585f24d8184a4cca7484afbb3fda93fbf4))
* **oauth:** Return 'id' not 'message' for message upload requests against Gmail API and MS Graph API ([d1bd122](https://github.com/BRAVO68WEB/emailengine-foss/commit/d1bd1226f6297224efed6775bc8d72b656b8faa0))
* **oauth:** Update Redis hash mapping when OAuth email changes ([82c1d89](https://github.com/BRAVO68WEB/emailengine-foss/commit/82c1d89dcf81edc198bcdf3dcc266506cb534da2))
* **outlook:** Fix MS Graph webhook subscription expiration issues ([1153313](https://github.com/BRAVO68WEB/emailengine-foss/commit/1153313868fae506cee9c13805628fddf6101e17))
* **outlook:** Improve delegated user handling and add clarifying comments ([cef7d25](https://github.com/BRAVO68WEB/emailengine-foss/commit/cef7d25fe1726e029181566622e156309c800f8a))
* **outlook:** Preserve calendar invite functionality when sending via Graph API ([92bd7f8](https://github.com/BRAVO68WEB/emailengine-foss/commit/92bd7f89c93e5998da400986fe698aff9c4d7fc0))
* **outlook:** Request specific body content type from MS Graph API ([9428852](https://github.com/BRAVO68WEB/emailengine-foss/commit/9428852c6f79721c9422698de25edc8ba9cfec8d))
* **outlook:** Use structured message format for Graph API sendMail to respect from field ([c1bf874](https://github.com/BRAVO68WEB/emailengine-foss/commit/c1bf8745fc0ceb0013428065a1dcb932781ae3de))
* preserve threadId for large Gmail threaded replies via multipart upload ([b04c2ca](https://github.com/BRAVO68WEB/emailengine-foss/commit/b04c2cac6bc7a6dfe347a800b57ed0bd1a21291a))
* prevent 500 error when listing accounts with invalid delegation config ([8651bcc](https://github.com/BRAVO68WEB/emailengine-foss/commit/8651bcc3c18cd54ee5309b3392915773c355e6c4))
* prevent ArrayBuffer detachment and IMAP null reference errors ([3b97372](https://github.com/BRAVO68WEB/emailengine-foss/commit/3b9737234b6f71ae9c1adbf4018134cc6bb4a070))
* prevent concurrent export race condition with atomic Redis operation ([dbc14f6](https://github.com/BRAVO68WEB/emailengine-foss/commit/dbc14f683ef8509003699a12ff60ec26001522fa))
* prevent sync state corruption from invalid uidNext values ([533f026](https://github.com/BRAVO68WEB/emailengine-foss/commit/533f026933fbbefb8b6998e412dc8cf3693c2b9b))
* prevent sync state corruption from invalid uidValidity values ([976fdb7](https://github.com/BRAVO68WEB/emailengine-foss/commit/976fdb7a1a74127c6c738b331f2c5aa8b7daddb4))
* prevent UTF-8 data corruption in OAuth request Buffer handling ([14361fd](https://github.com/BRAVO68WEB/emailengine-foss/commit/14361fdc4c7c04ad2ca5934eb4d418abf1c66289))
* race condition in runFullSync and add diagnostic logging ([#549](https://github.com/BRAVO68WEB/emailengine-foss/issues/549)) ([cdb3fe1](https://github.com/BRAVO68WEB/emailengine-foss/commit/cdb3fe18b2494cc02f1e50e98ffddf0003329dd2))
* **redis:** Add recovery mechanism for disconnected accounts after Redis reconnection ([ac9737a](https://github.com/BRAVO68WEB/emailengine-foss/commit/ac9737a98bdb50220278e809de408582f789cf05))
* **redis:** Improve Redis reconnection handling for IMAP workers ([de7327e](https://github.com/BRAVO68WEB/emailengine-foss/commit/de7327e08ca676607433890060f045bbc851a3a7))
* **redis:** Tolerate Redis reconnections better ([5d3627c](https://github.com/BRAVO68WEB/emailengine-foss/commit/5d3627c62662428e3a9e9316f54ff4cd8062fcce))
* Reduce production node_modules size by removing unused static-only deps ([af9d584](https://github.com/BRAVO68WEB/emailengine-foss/commit/af9d584d4ad806e8a0b9eb7e59e6d5c8c8ff8878))
* reject invalid nonce format instead of silently regenerating ([422ea5c](https://github.com/BRAVO68WEB/emailengine-foss/commit/422ea5c3dc56f4cf1679a1783d4c108d1486f455))
* remove BullMQ job when marking interrupted exports as failed ([ad587a7](https://github.com/BRAVO68WEB/emailengine-foss/commit/ad587a7e0e536f2cb1647f420daa338e24d24233))
* Remove CPU metrics collection to prevent potential native code issues ([350afc2](https://github.com/BRAVO68WEB/emailengine-foss/commit/350afc2a74e2935f74ad0b00110cd6e67eafc5b0))
* removed dotenv debug log line ([9c5fc1b](https://github.com/BRAVO68WEB/emailengine-foss/commit/9c5fc1b4b3cb1c38c7604eec75f5427bf0f8482b))
* Rename IMAP worker to Email worker in thread display ([95b39da](https://github.com/BRAVO68WEB/emailengine-foss/commit/95b39da07c7ee28ac0539f6599546bc49af8e0ac))
* Replace v8.getHeapStatistics with process.memoryUsage to prevent SEGV errors ([918dba7](https://github.com/BRAVO68WEB/emailengine-foss/commit/918dba7682a6e50f6aec8c91fe1e35a3f0eb2928))
* resolve 11 bugs in export functionality ([f5d2621](https://github.com/BRAVO68WEB/emailengine-foss/commit/f5d2621bbaa2cf3b1dab06c67a7e2d5bf29075ed))
* resolve Gmail label IDs to human-readable names ([02c306f](https://github.com/BRAVO68WEB/emailengine-foss/commit/02c306f10f29d8941f242f9283684621fefcd5c3))
* resolve OpenAPI spec validation errors for token restrictions ([a9cffe1](https://github.com/BRAVO68WEB/emailengine-foss/commit/a9cffe150843fb7f8b4f7f5d01afc69ef451bac2))
* restore retry for empty Buffer payloads and fix large threaded Gmail replies ([107c164](https://github.com/BRAVO68WEB/emailengine-foss/commit/107c16475a2278a9428903d7280f481cf62a64ec))
* return WorkerNotAvailable immediately and remove batch submit endpoint ([aed5c45](https://github.com/BRAVO68WEB/emailengine-foss/commit/aed5c45aeec37a42b6c7113a3e45cb7153ae67bb))
* Reverted ICOn handling for windows app ([7abba87](https://github.com/BRAVO68WEB/emailengine-foss/commit/7abba87b749ed36ccd663dabfc26fa7a2d2b320d))
* schema updates for message update ([4d293a1](https://github.com/BRAVO68WEB/emailengine-foss/commit/4d293a1954b9d7968c95a758175882a640292328))
* **schema:** Updated settings schema descriptions. Added imapClient... setting keys to configure RFC2971 IMAP ID extension ([bc38322](https://github.com/BRAVO68WEB/emailengine-foss/commit/bc383225a522c4c7b1912f260f9a902a6e4be4b1))
* **search:** Prefer WITHIN extension and YOUNGER/OLDER for SINCE/BEFORE searches ([34d5889](https://github.com/BRAVO68WEB/emailengine-foss/commit/34d5889b84812537ca592089f58abde5d4005223))
* send Buffer for Outlook sendMail base64 payload to avoid JSON quoting ([e89a924](https://github.com/BRAVO68WEB/emailengine-foss/commit/e89a924343bf8ba3ea1fd7e75bc09aa53c2177b2))
* show Failed status for accounts with IMAP disabled due to auth errors ([e6b687d](https://github.com/BRAVO68WEB/emailengine-foss/commit/e6b687d458cfd080795f7176f862109e2c299fff))
* Show the token description on the delete token confirmation modal ([495af4f](https://github.com/BRAVO68WEB/emailengine-foss/commit/495af4fb860e705b983674a5e8d708a09ef9de20))
* Simplify memory display in internals page ([8dc284b](https://github.com/BRAVO68WEB/emailengine-foss/commit/8dc284b90360f747dd0c7d98115b5352544a028b))
* **smtp-interface:** Add configurable SMTP message size limit ([c3692b9](https://github.com/BRAVO68WEB/emailengine-foss/commit/c3692b929fded1f48f1054da1777a19378908b0f))
* **smtp:** Improved Message-ID rewriting detection for AWS SES ([fbe7ff3](https://github.com/BRAVO68WEB/emailengine-foss/commit/fbe7ff3b99b4142cc263d15dcea47733f343a2ce))
* Special envelope handling for LarkSuite accounts ([f448d39](https://github.com/BRAVO68WEB/emailengine-foss/commit/f448d39ecb958f926c05a28d7ad3ca110f16c17a))
* stabilize Swagger model names for SDK generation ([8078830](https://github.com/BRAVO68WEB/emailengine-foss/commit/80788305f23eee9d021b4c72dce21961493ca093))
* **submit:** Added configuration ENV option EENGINE_SUBMIT_DELAY / --submitDelay=duration argument to allow rate limiting message sending (this is global, not account specific) ([531caad](https://github.com/BRAVO68WEB/emailengine-foss/commit/531caadb00d8b7d8710668509845d9452c9c924d))
* **submit:** Added new message reference action 'reply-all' ([b0bd69f](https://github.com/BRAVO68WEB/emailengine-foss/commit/b0bd69f8ac5abc9b63110cc8eaf63f2ba41b8b64))
* **translations:** Added Polish translations; Merge pull request [#497](https://github.com/BRAVO68WEB/emailengine-foss/issues/497) from jakubmieszczanin/master ([b0b29e5](https://github.com/BRAVO68WEB/emailengine-foss/commit/b0b29e5e716724d2e143afd7120c0677bfbe6fec))
* **translations:** Allow changing active language with ?lang=lang_code query argument ([1f2a0e6](https://github.com/BRAVO68WEB/emailengine-foss/commit/1f2a0e6070a9dfa5989e6055648fb1d0f4d8c095))
* **UI:** prevent trying to format a non-existing timestamp value ([d97bb92](https://github.com/BRAVO68WEB/emailengine-foss/commit/d97bb923de611c5bd45b0ef7df1ddbbec0b184b1))
* **ui:** Replaced 2024 with 2025 in static HTML pages ([99e805b](https://github.com/BRAVO68WEB/emailengine-foss/commit/99e805b5ce1e373b60bbaa2b9f0fa138f8f8d27b))
* update gettext script to include refactored UI route files ([5b2e4a5](https://github.com/BRAVO68WEB/emailengine-foss/commit/5b2e4a55771f192fb14d030b5e5d08ba860c90ab))
* Update internals page to handle new memory usage format ([cf0de82](https://github.com/BRAVO68WEB/emailengine-foss/commit/cf0de827b17b13e9234d347f5f6686de29bfb7d2))
* update test expectations for email-text-tools 2.3.5+ behavior ([1e28abf](https://github.com/BRAVO68WEB/emailengine-foss/commit/1e28abf77282ac4c550f9834f61064ae8fde7de9))
* use base64url encoding for OAuth state nonce in /v1/authentication/form ([1f2cecf](https://github.com/BRAVO68WEB/emailengine-foss/commit/1f2cecf9efbee8a12c3a0d27c9879bfbbf7dfa39))
* use base64url encoding for OAuth state nonce in /v1/authentication/form ([dead38c](https://github.com/BRAVO68WEB/emailengine-foss/commit/dead38c348f1c0204f2bfba09997090cb86c348b))
* use base64url encoding for OAuth state nonce in remaining locations ([961b710](https://github.com/BRAVO68WEB/emailengine-foss/commit/961b710357d836782c9bbce329178aa96e08ee20))
* use consistent index source in batch submit success and failure paths ([3a73704](https://github.com/BRAVO68WEB/emailengine-foss/commit/3a737047c1f1e4fda6bd7c4b6822ca31ebe27fd2))
* validate nonce format before using data.n from cached URLs ([d825303](https://github.com/BRAVO68WEB/emailengine-foss/commit/d82530395e93e88f5841156a53fe41d476eec9da))
* **verify:** Slightly faster account data verification ([3e27d5e](https://github.com/BRAVO68WEB/emailengine-foss/commit/3e27d5e75f4a59e97aca7a3eff8a041c3d540935))
* **virtual-list:** Fixed authentication requirement for the public re-subscribe page ([956fdfa](https://github.com/BRAVO68WEB/emailengine-foss/commit/956fdfaaa0946004939e9774a42306b50b51d7aa))
* **web:** Fixed preview function for public website templates in the admin UI ([6f3567b](https://github.com/BRAVO68WEB/emailengine-foss/commit/6f3567be5abd796f3397014a37021809a6645112))
* **webhook-routing:** Do not throw 500 when viewing a failing webhook routing page ([a8acde2](https://github.com/BRAVO68WEB/emailengine-foss/commit/a8acde26cedda4831b0996805adc7bcacc4c807e))
* **webhooks:** Explicitly set Content-Length to prevent undici mismatch errors ([40cb42d](https://github.com/BRAVO68WEB/emailengine-foss/commit/40cb42dfefdbc55eb2eca5c61c15565de5e85d8e))
* **webhooks:** Include a HMAC signature in webhook headers ([7516188](https://github.com/BRAVO68WEB/emailengine-foss/commit/75161881c9100c2d5a2bec22790aa3311a2de87f))
* **webhooks:** Include envelope property in messageSent for Gmail API and MS Graph API submissions ([6b1a3fa](https://github.com/BRAVO68WEB/emailengine-foss/commit/6b1a3fa98b6370af5ba006ee486d400737fd9845))
* **webhooks:** Show more informational messages when webhooks fail ([0712f0a](https://github.com/BRAVO68WEB/emailengine-foss/commit/0712f0a0d547b61ba95be34346523ee8fe32210f))
* **websafe:** Process web safe HTML before injecting base64 attachments to speed the process up ([b04d0fe](https://github.com/BRAVO68WEB/emailengine-foss/commit/b04d0fed1852677a6787438d1d0f73f2d9cc4f4d))
* **worker-close:** If worker dies then do not try to update accounts statuses to prevent race conditions ([d532365](https://github.com/BRAVO68WEB/emailengine-foss/commit/d532365b321efef63d3c68965631b61381533c45))
* **workmail:** better detection of bounce emails with AWS WorkMail ([1a8e750](https://github.com/BRAVO68WEB/emailengine-foss/commit/1a8e7503447f1a6db4b67fa9771374274c9f2e3b))
* Wrap async close handler await calls in try-catch to prevent unhandled rejections ([c6df321](https://github.com/BRAVO68WEB/emailengine-foss/commit/c6df321c7a580c1cd10d2e1eac5681aa49e4c87a))


### Performance Improvements

* use MS Graph batch API for Outlook message export ([f031f77](https://github.com/BRAVO68WEB/emailengine-foss/commit/f031f770278a14aeb2fd5a589e31bb5621b0c410))


### Reverts

* remove Swagger UI light mode forcing ([9c9bd25](https://github.com/BRAVO68WEB/emailengine-foss/commit/9c9bd25e4488828e3112e671df12d1c551957dac))
